...
public class JapanPage extends AppCompatActivity {
    SharedPreferences pref;
    private static final String PREF_NAME = "SaveJapan";
    EditText date, location, name;
    Spinner spinner;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.activity_japan);
        ...
        update.setOnClickListener(e -> {
            Intent intent = new Intent(JapanPage.this, UpdatePage.class);
            intent.putExtra("fromClass", "japanclass");
